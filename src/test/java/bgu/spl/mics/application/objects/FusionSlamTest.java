...
public class FusionSlamTest {
    ...
    public void testProcessTrackedObjects_AddNewLandMark() {
        ...
        assertEquals("Test Object", landmarks.get(0).getDescription(), "The landmark description should be 'Test Object'");
    }
    ...
    public void testProcessTrackedObjects_UpdateExistingLandMark() {
        ...
        assertEquals("Test Object", landmarks.get(0).getDescription(), "The landmark description should still be 'Test Object'");
        ...
        assertEquals(2.0, updatedCloudPoints.get(0).getX(), 0.001, "The first cloud point X coordinate should be updated");
        assertEquals(2.0, updatedCloudPoints.get(0).getY(), 0.001, "The first cloud point Y coordinate should be updated");
        assertEquals(3.0, updatedCloudPoints.get(1).getX(), 0.001, "The second cloud point X coordinate should be updated");
        assertEquals(3.0, updatedCloudPoints.get(1).getY(), 0.001, "The second cloud point Y coordinate should be updated");
    }
}